...
if ($etape == "choixVisiteur") {
    ...
    // recherche des éléments modifiés
    // puis mise à jours
...
<div id="contenu">
    ...
    if ($visiteurSaisi != "") {
        ?>      
        <!--Si le visiteur est choisi on propose les mois le concernant-->
    ...
    <!--une fois le visiteur et le mois choisi on affiche les renseignements -->
    <?php
    if ($visiteurSaisi != "" && $moisSaisi != "") {
        ...
        <div id="divModifHF" class="fondTableau">
            ...
            while (is_array($lgEltHorsForfait)) {
                ...
                $lgEltHorsForfait = mysql_fetch_assoc($idJeuEltsHorsForfait);
                ?>
                <!--Création de chaque ligne de frais hors forfait-->
                <form id="formLigneHF<?php echo $idHF; ?>" action="" method="post">
                    ...
                    <table>
                        ...
                        <?php if (strpos($libelleHF, "REFUSER") == FALSE) {
                            ...
                            <td>
                                <!--Proposition des actions possibles pour chaque ligne-->
